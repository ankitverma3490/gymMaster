    ...
    <>
      ...
      >
        ...
        <div className="crm-header d-flex flex-column flex-md-row justify-content-between align-items-center p-3">
          <div className="crm-title mb-2 mb-md-0">Prospects</div>
          <div className="crm-header-buttons d-flex flex-wrap gap-2 justify-content-center">
            ...
            <Link to="/addmember">
              <button
                ...
                style={{ backgroundColor: "#337ab7" }}
              >
                <i className="bi bi-plus" /> Add Prospect
              </button>
            </Link>
          </div>
        </div>
        ...
        >
          ...
          <div className="col-md-3">
            <div className="crm-tab fw-semibold mb-2">
              Uncontacted <span className="stage-counter">134</span>
            </div>
            {/* Prospect Cards */}
            <div
              id="uncontacted-column"
              ...
              onDrop={(e) => handleDrop(e, "uncontacted-column")}
            ...
            >
              ...
              >
                <div className="d-flex justify-content-between">
                  <div className="crm-prospect-name">Anthony Turnage</div>
                  <small>Alyssa Kathan</small>
                </div>
                <div className="crm-prospect-info">
                  <div className="crm-prospect-details">
                    Reserve Golf Simulator 141 days ago
                  </div>
                  <div className="d-flex gap-1">
                    <button className="crm-action-btn">Actions</button>
                    <button className="crm-heart-btn">
              ...
              >
                <div className="d-flex justify-content-between">
                  <div className="crm-prospect-name">Leo Urbanski</div>
                  <small>Alyssa Kathan</small>
                </div>
                <div className="crm-prospect-info">
                  <div className="crm-prospect-details">
                    Emailed 141 days ago
                  </div>
                  <div className="d-flex gap-1">
                    <button className="crm-action-btn">Actions</button>
                    <button className="crm-heart-btn">
              ...
              >
                <div className="d-flex justify-content-between">
                  <div className="crm-prospect-name">David Moreno</div>
                  <small>Alyssa Kathan</small>
                </div>
                <div className="crm-prospect-info">
                  <div className="crm-prospect-details">
                    Reserve Golf Simulator 139 days ago
                  </div>
                  <div className="d-flex gap-1">
                    <button className="crm-action-btn">Actions</button>
                    <button className="crm-heart-btn">
              ...
              >
                <div className="d-flex justify-content-between">
                  <div className="crm-prospect-name">Jeremy Burkart</div>
                  <small>Alyssa Kathan</small>
                </div>
                <div className="crm-prospect-info">
                  <div className="crm-prospect-details">
                    Reserve Golf Simulator 137 days ago
                  </div>
                  <div className="d-flex gap-1">
                    <button className="crm-action-btn">Actions</button>
                    <button className="crm-heart-btn">
              ...
              >
                <div className="d-flex justify-content-between">
                  <div className="crm-prospect-name">Keith Chambers</div>
                  <small>Alyssa Kathan</small>
                </div>
                <div className="crm-prospect-info">
                  <div className="crm-prospect-details">
                    Reserve Golf Simulator 120 days ago
                  </div>
                  <div className="d-flex gap-1">
                    <button className="crm-action-btn">Actions</button>
                    <button className="crm-heart-btn">
              ...
              >
                <div className="d-flex justify-content-between">
                  <div className="crm-prospect-name">Adam Porwit</div>
                  <small>Alyssa Kathan</small>
                </div>
                <div className="crm-prospect-info">
                  <div className="crm-prospect-details">
                    Enquired 112 days ago
                  </div>
                  <div className="d-flex gap-1">
                    <button className="crm-action-btn">Actions</button>
                    <button className="crm-heart-btn">
              ...
              >
                <div className="d-flex justify-content-between">
                  <div className="crm-prospect-name">A Williams</div>
                  <small>Alyssa Kathan</small>
                </div>
                <div className="crm-prospect-info">
                  <div className="crm-prospect-details">
              ...
              >
                <div className="d-flex justify-content-between">
                  <div className="crm-prospect-name">Adam Umbarger</div>
                  <small>Alyssa Kathan</small>
                </div>
                <div className="crm-prospect-info">
                  <div className="crm-prospect-details">
              ...
              >
                <div className="d-flex justify-content-between">
                  <div className="crm-prospect-name">Alan Burton</div>
                  <small>Alyssa Kathan</small>
                </div>
                <div className="crm-prospect-info">
                  <div className="crm-prospect-details">
          ...
          <div className="col-md-3">
            <div className="crm-tab fw-semibold mb-2">
              Contacted (No Answer) <span className="stage-counter">1</span>
            </div>
            <div
              id="contacted-column"
              ...
              onDragOver={handleDragOver}
              onDrop={(e) => handleDrop(e, "contacted-column")}
              onDragLeave={handleDragLeave}
            >
              <div
                className="crm-prospect-card"
              ...
              <div className="crm-not-interested mt-2">Not Interested</div>
            </div>
          </div>
          {/* Fourth Column - Follow Up */}
          <div className="col-md-3">
            <div className="crm-tab fw-semibold mb-2">
              Follow Up <span className="stage-counter">0</span>
            </div>
            <div
              id="followup-column"
              ...
              style={{ borderRight: "1px solid lightgray", height: "70%" }}
              onDragOver={handleDragOver}
              onDrop={(e) => handleDrop(e, "followup-column")}
              onDragLeave={handleDragLeave}
            ></div>
          </div>
          ...
          <div className="col-md-3">
            <div className="crm-tab fw-semibold mb-2 ps-3">
              Booked APPT <span className="stage-counter">0</span>
            </div>
            <div
              id="booked-column"
