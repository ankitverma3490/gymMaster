...
const InputStockDelivery = () => {
  return (
    <>
      ...
      <div style={{ position: "relative", top: "182px" }}>
        <Footer />
      </div>
    </>
  );
...
export default InputStockDelivery;
