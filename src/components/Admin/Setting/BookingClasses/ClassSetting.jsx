    ...
    <>
      <div className="container-fluid    ">
           ...
           <div className="d-flex mb-3">
            <ul className="nav nav-tabs">
              <li className="nav-item">
                <button
                  className={`nav-link ${activeTab === 'Advanced' ? '' : ''}`}
        ...
        <div className=" ">
                ...
                <div className=" mb-3">
                  <div className="card-body">
                    <div className="form-check mb-3">
                      <input className="form-check-input" type="checkbox" id="openEnrollment" />
                      <label className="form-check-label fw-bold" htmlFor="openEnrollment">
                        Open class enrollments at selected time
                      </label>
                      <div className="ms-4 text-muted">
                        Allow class enrollments to open at a pre-selected time. Default is midnight
                      </div>
                    </div>

                    <div className="mb-3">
                      <div className="fw-bold mb-2">Open class bookings online</div>
                      <div className="ms-4 text-muted">
                        Select time-frame prior to class beginning when online bookings are to open
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="card-body">
            <div className="form-group mb-3">
              <label htmlFor="daysBeforeClass" className="form-label">
                Days before class to open bookings
              </label>
              <div className="d-flex">
                <input
                  ...
                  id="daysBeforeClass"
                  className="form-control"
                  value={daysBeforeClass}
                  onChange={(e) => setDaysBeforeClass(e.target.value)}
                />
                <select
              ...
              <div className="ms-4 text-muted">
                Default Value: 2 Weeks | Last Changed: Dec 19, 2024 9:03 pm by Mike Bell
              </div>
            </div>
          </div>
        </div>
        ...
        <div className=" mb-4">
          <div className="card-body">
            <div className="form-group mb-3">
              <label htmlFor="minutesBeforeClass" className="form-label">
                Close class bookings online
              </label>
              <div className="d-flex">
                <input
                  type="number"
                  id="minutesBeforeClass"
                  className="form-control"
                  value={minutesBeforeClass}
                  onChange={(e) => setMinutesBeforeClass(e.target.value)}
                />
                <select
                  className="form-select ms-2"
                  aria-label="Select time unit"
              ...
              <div className="ms-4 text-muted">
                Select time-frame prior to class beginning when online bookings are to close.
                <br />
                Last Changed: Nov 3, 2024 9:41 pm by Mike Bell
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="card-body">
            <div className="form-check mb-3">
              <input
                ...
                type="checkbox"
                id="enableBookingEmail"
                checked={enableEmail}
                onChange={() => setEnableEmail(!enableEmail)}
              />
              <label className="form-check-label fw-bold" htmlFor="enableBookingEmail">
                Enable class booking confirmation email
              </label>
              <div className="ms-4 text-muted">
                Send confirmation email for class bookings
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="card-body">
            <div className="form-group mb-3">
              ...
              <select
                ...
                onChange={(e) => setSelecteTemplate(e.target.value)}
              >
                <option value="Member Portal Class Booking">Member Portal Class Booking</option>
                <option value="Other Template">Other Template</option>
              </select>
              <div className="ms-4 text-muted">
                The email template used when a member books a class online.
              </div>
            </div>
          </div>
        </div>
...
<div className="mt-4 mb-4">
        ...
        {/* Save Button */}
            ...
            {activeTab === 'Features' && (
              <div>
                <h4 className="mb-4">Feature Settings</h4>
                <p>Here you can configure the features related to your system.</p>
              </div>
            )}
          </div>
        </div>
