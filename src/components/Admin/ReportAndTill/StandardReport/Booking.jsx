        ...
        <div className="accordion accordion-flush" id="accordionFlushExample">
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body bg-light">
                <p>
                All bookings made during a given period.
                </p>
                <div className="row">
          ...
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body bg-light">
                <p>
                Shows booking stats for all classes in period, including waitlist movements.
                </p>
                <div className="row">
                  <div className="col-md-6">
                    <h6 className="my-2">Select A Date Range</h6>
          ...
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body bg-light">
                <p>
                Unchecked in bookings in given date range.
                </p>
                <div className="row">
                  <div className="col-md-6">
                    <h6 className="my-2">Select A Date Range</h6>
          ...
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body bg-light">
                <p>
                Members who have cancelled bookings during the given period.
                </p>
                <div className="row">
                  <div className="col-md-6">
                    <h6 className="my-2">Select A Date Range</h6>
          ...
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body bg-light">
                <p>
                All members/non-members who attended classes in the start/end period.
                </p>
                <div className="row">
                  <div className="col-md-6">
                    <h6 className="my-2">Select A Date Range</h6>
          ...
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body bg-light">
                <p>
                Statistics for classes and how well they are run and occupied.
                </p>
                <div className="row">
                  <div className="col-md-6">
                    <h6 className="my-2">Select A Date Range</h6>
          ...
          <div className="accordion-item">
            <h2 className="accordion-header" id="flush-headingSeventh">
              ...
              >
                Class Performance and Revenue Received
              </button>
            </h2>
            <div
            ...
            >
              <div className="accordion-body bg-light">
                <p className="mb-4">
                Statistics for classes including Sales Revenue Information
                </p>
                <div className="mb-3 form-check">
                  <input
                    type="checkbox"
          ...
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body bg-light">
                <p>
                A breakdown of class attendances over the given period.
                </p>
                <div className="row">
                  <div className="col-md-6">
                    <h6 className="my-2">Select A Date Range</h6>
          ...
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body bg-light">
                <p>All meetings that were scheduled in the period</p>
                <div className="row">
                  <div className="col-md-6">
                    <h6 className="my-2">Select A Date Range</h6>
                    <button
          ...
          <div className="accordion-item">
            <h2 className="accordion-header" id="flush-headingTenth">
              ...
              >
                Members Class Bookings in Period
              </button>
            </h2>
            <div
            ...
            >
              <div className="accordion-body bg-light">
                <p>
                Member class booking activity within the given date range, covering attendance and cancellations.
                </p>
                <div className="row">
                  <div className="col-md-6">
                    <h6 className="my-2">Select A Date Range</h6>
          ...
          <div className="accordion-item">
            <h2 className="accordion-header" id="flush-headingEleventh">
              ...
              >
                Members Training Bookings in Period
              </button>
            </h2>
            <div
            ...
            >
              <div className="accordion-body bg-light">
                <p>
                Member trainer/other booking activity within the given date range, covering attendance and cancellations.
                </p>
                <div className="row">
                  <div className="col-md-6">
                    <h6 className="my-2">Select A Date Range</h6>
          ...
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body bg-light">
                <p>
                Summary of all booking resource types during the given period.
                </p>
                <div className="row">
                  <div className="col-md-6">
                    <h6 className="my-2">Select A Date Range</h6>
