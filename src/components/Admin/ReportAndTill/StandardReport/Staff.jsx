        ...
        <div className="accordion accordion-flush" id="accordionFlushExample">
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body bg-light">
                <p>
                All staff that joined between the given dates, includes historic staff members.
                </p>
                <div className="row">
          ...
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body bg-light">
                <p>
                All bookings made with personal trainers during a given period.
                </p>
                <div className="row">
                  <div className="col-md-6">
                    <h6 className="my-2">Select A Date Range</h6>
          ...
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body bg-light">
                <p>
                Individual personal trainer performance made during the given period.
                </p>
                <div className="row">
                  <div className="col-md-6">
                    <h6 className="my-2">Select A Date Range</h6>
          ...
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body bg-light">
                <p>
                Count sessions completed by personal trainers.
                </p>
                <div className="row">
                  <div className="col-md-6">
                    <h6 className="my-2">Select A Date Range</h6>
          ...
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body bg-light">
                <p>
                Lists all of the staffs access rights per club. If they have no acess to a section, it will not be included
                </p>
                <div className="row">
                  <div className="col-md-6">
                    <h6 className="my-2">Select A Date Range</h6>
          ...
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body bg-light">
                <p>
                Shows all active staff of GymMaster, NOTE: Start and End dates of reports do nothing
                </p>
                <div className="row">
                  <div className="col-md-6">
                    <h6 className="my-2">Select A Date Range</h6>
          ...
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body bg-light">
                <p className="mb-4">
                Membership sales per staff member in period, as well as the ongoing return for those memberships sold in this period and the retention numbers of those memberships sold.
                </p>
                <div className="mb-3 form-check">
                  <input
                    type="checkbox"
