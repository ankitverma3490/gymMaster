        ...
        <div className="accordion accordion-flush" id="accordionFlushExample">
          ...
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body bg-light">
                <p>
                  This report includes anyone who has been a current member in
                  this period. Some members listed may have expired or were
                  cancelled, but were current at one stage during the reported
                  period. We recommend running this report with the same start
                  and end date.
                </p>
                <div className="row">
                  <div className="col-md-6">
          ...
          <div className="accordion-item">
            <h2 className="accordion-header" id="flush-headingFourth">
              ...
              >
                ...
                Current Members (excluding those starting in Nov/Dec)
              </button>
            </h2>
            <div
            ...
            >
              <div className="accordion-body bg-light">
                <p>
                  ...
                  cancelled, but were current at one stage during the reported
                  period. We recommend running this report with the same start
                  and end date. (Copy of "Current Members" report)
                </p>
                <div className="row">
                  <div className="col-md-6">
                    <h6 className="my-2">Select A Date Range</h6>
          ...
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body bg-light">
                <p>
                  Members who owe money at the specified start date of the
                  report
                </p>
                <div className="row">
                  <div className="col-md-6">
          ...
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body bg-light">
                <p>
                  Members whose membership will expire during the given period,
                  excluding members who have cancelled their membership.
                </p>
                <div className="row">
                  <div className="col-md-6">
                    <h6 className="my-2">Select A Date Range</h6>
